export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'dailypavel',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Dailypavel',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'dailypavel.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://dailypavel.com',
